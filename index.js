    ...
    var mappedItem1 = items.data.results.map(function(item){
        ...
        <div class="moviesCard">
            <img src=${'http://image.tmdb.org/t/p/original'+`${item.poster_path}`}
                alt="">
            <div class="moviesCard_foot row no-gutters mt-3">
                <div class="foot">
                ...
                <button class="btn foot ms-auto shadow-none"><a href=${link1}>read
                        more</a></button>
            </div>
        </div>
    </div>`
    ...
    var mappedItem2 = items.data.results.map(function(item){
        ...
        <div class="moviesCard">
            ...
            <div class="moviesCard_foot row no-gutters mt-3">
                ...
                <button class="btn foot ms-auto shadow-none"><a href=${link2}>read
                        more</a></button>
            </div>
        </div>
    </div>`
    ...
    var mappedItem3 = items.data.results.map(function(item){
        ...
        <div class="moviesCard">
            ...
            <div class="moviesCard_foot row no-gutters mt-3">
                ...
                <button class="btn foot ms-auto shadow-none"><a href=${link3}>read
                        more</a></button>
            </div>
        </div>
    </div>`
