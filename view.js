$(document).ready(async function(){
    ...
    var page = await axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=403c1367f4654d78c7dc442cf20384a5&language=en-US&sort_by=vote_count.desc&page=${page_no}`)
...
$(document).ready(async function() {
    var page = await axios.get('https://api.themoviedb.org/3/discover/movie?api_key=403c1367f4654d78c7dc442cf20384a5&language=en-US&sort_by=vote_count.desc')
